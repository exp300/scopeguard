...
export const clauses = [
  // ─── Scope & Deliverables ─────────────────────────────────────────────
  {
    ...
    realScenario:
      'A logo designer signs a $1,500 project with "unlimited revisions." Three months in, they\'ve done 27 revisions across 14 different concepts. The client keeps moving the goalpost. The designer can\'t walk away because the contract says "until satisfied," and ends up earning roughly $8/hour by the time they finally agree to launch.',
  },
  {
    ...
    fix: 'Replace with a detailed Scope of Work. Anything not listed is explicitly excluded: "The deliverables listed in Section 2 are the complete scope. Any work not described in this SOW requires a written change order, signed by both parties, before contractor begins the additional work."',
    realScenario:
  ...
  },
  {
    ...
    realScenario:
      'A copywriter delivers a website\'s worth of copy on July 1. The client says "looks great, just let me share with the team." Six weeks later they\'re still "gathering feedback." The copywriter has no leverage, because final payment is tied to approval. They eventually accept 50% just to close the project.',
  },
  {
    ...
    danger:
      'No one can agree on what "design complete" means. This leads to endless disputes about whether a phase is done, which means you can\'t invoice for completed phases, which means cash flow gets blocked. Vague milestones also invite scope creep, because clients keep "polishing" Phase 1 forever rather than moving forward.',
  ...
  },
  {
    ...
    fix: '"License to use deliverables is contingent on full payment of all outstanding invoices. Until payment is received in full, contractor retains exclusive rights to all deliverables. Use of deliverables prior to full payment constitutes an unauthorized use." This turns non-payment into a copyright infringement issue rather than only a debt-collection problem, which is much easier to act on.',
    realScenario:
  ...
  },
  {
    ...
    danger:
      'You have zero control over whether their manager approves or their funding round closes. You\'ve already done the work. Funding rounds get delayed all the time. Managers leave. Internal politics shift overnight. None of those things should affect whether you get paid for work you\'ve already finished. This clause transfers business risk from the client to you.',
    fix: 'Remove conditional language entirely. Tie payment to your delivery, not to their internal processes: "Payment is due 14 days from invoice date. Internal approval, funding events, or third-party processing delays do not extend the payment due date." If they push back, ask for an upfront deposit instead.',
    realScenario:
